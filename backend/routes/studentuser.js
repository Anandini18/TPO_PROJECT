...
const jwtSecret = 'e5a47ca8ca7b5d9fdb2464dc8ba552fc9e7f3797b974f50f0d255a921a132127'
...
router.post("/register", async (req, res) => {
  ...
  try {
    ...
    const token = Jwt.sign({ student }, jwtSecret, {
      expiresIn: "7h",
    });
...
router.post('/change-password', async (req, res) => {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "tushar.test.4@gmail.com",
        pass: "bfhvvzoypudtabqs"
      }
    });
    const mailOptions = {
